...
func _() {
	...
	_ = x[Aggregation_DISTINCT_COUNT-8]
}

const _AggregationType_name = "MAXMINMEANMEDIANSTDSUMCOUNTDISTINCTCOUNT"

var _AggregationType_index = [...]uint8{0, 3, 6, 10, 16, 19, 22, 27, 40}
